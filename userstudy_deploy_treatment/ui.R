...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("Marking Instructions", uiOutput("page_content"), value = "tab_4"),
    tabPanel("1", uiOutput("page_content"), value = "tab_5"),
    tabPanel("2", uiOutput("page_content"), value = "tab_6"),
    tabPanel("3", uiOutput("page_content"), value = "tab_7"),
