...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("1", uiOutput("page_content"), value = "tab_3"),
    tabPanel("2", uiOutput("page_content"), value = "tab_4"),
    tabPanel("3", uiOutput("page_content"), value = "tab_5"),
    tabPanel("4", uiOutput("page_content"), value = "tab_6"),
    tabPanel("5", uiOutput("page_content"), value = "tab_7"),
    tabPanel("6", uiOutput("page_content"), value = "tab_8"),
    tabPanel("7", uiOutput("page_content"), value = "tab_9"),
    tabPanel("8", uiOutput("page_content"), value = "tab_10"),
    tabPanel("9", uiOutput("page_content"), value = "tab_11"),
    tabPanel("10", uiOutput("page_content"), value = "tab_12"),
    tabPanel("Survey", uiOutput("page_content"), value = "tab_13"),
    tabPanel("Done!", uiOutput("page_content"), value = "tab_14")
  ),
