...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("Prolific Introduction", uiOutput("page_content"), value = "tab_2"),
    tabPanel("Study Introduction", uiOutput("page_content"), value = "tab_3"),
    tabPanel("Annotation Instructions", uiOutput("page_content"), value = "tab_4"),
    tabPanel("Annotation Practice", uiOutput("page_content"), value = "tab_5"),
    tabPanel("1", uiOutput("page_content"), value = "tab_6"),
    tabPanel("2", uiOutput("page_content"), value = "tab_7"),
    tabPanel("3", uiOutput("page_content"), value = "tab_8"),
    tabPanel("4", uiOutput("page_content"), value = "tab_9"),
    tabPanel("5", uiOutput("page_content"), value = "tab_10"),
    tabPanel("6", uiOutput("page_content"), value = "tab_11"),
    tabPanel("Survey", uiOutput("page_content"), value = "tab_12"),
    tabPanel("Done!", uiOutput("page_content"), value = "tab_13")
  ),
