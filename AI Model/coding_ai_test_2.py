...
output_dir = "Auswertung_AI_test_2"
...
checkpointer = ModelCheckpoint(filepath = os.path.join(model_dir, 'best_model.keras_test_2'), verbose = 2, save_best_only = True)
...
model.load_weights(os.path.join(model_dir,'best_model.keras_test_2'))
model.summary()
