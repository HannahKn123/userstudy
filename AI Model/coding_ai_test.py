 ...
 # Iteriere über Klassenordner und importiere Bilder
  for class_folder in class_folders:
        ...
        for image_file in image_files:
            ...
            # Zielgröße und Normalisierung anwenden
            target_size = (448, 448)
            img = cv2.resize(img, target_size)  # Bildgröße anpassen
...
checkpointer = ModelCheckpoint(filepath = os.path.join(model_dir, 'best_model.keras_test'), verbose = 2, save_best_only = True)
...
model.load_weights(os.path.join(model_dir,'best_model.keras_test'))
model.summary()
